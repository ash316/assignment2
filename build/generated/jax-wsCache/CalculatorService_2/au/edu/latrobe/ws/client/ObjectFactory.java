 ...
 * generated in the au.edu.latrobe.ws.client package. 
...
public class ObjectFactory {
    ...
    private final static QName _Subtract_QNAME = new QName("http://ws.latrobe.edu.au/", "subtract");
    private final static QName _DivideByZeroException_QNAME = new QName("http://ws.latrobe.edu.au/", "DivideByZeroException");
    private final static QName _AddResponse_QNAME = new QName("http://ws.latrobe.edu.au/", "addResponse");
    private final static QName _MultiplyResponse_QNAME = new QName("http://ws.latrobe.edu.au/", "multiplyResponse");
    private final static QName _Divide_QNAME = new QName("http://ws.latrobe.edu.au/", "divide");
    private final static QName _Multiply_QNAME = new QName("http://ws.latrobe.edu.au/", "multiply");
    private final static QName _Add_QNAME = new QName("http://ws.latrobe.edu.au/", "add");
    private final static QName _DivideResponse_QNAME = new QName("http://ws.latrobe.edu.au/", "divideResponse");
    private final static QName _SubtractResponse_QNAME = new QName("http://ws.latrobe.edu.au/", "subtractResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: au.edu.latrobe.ws.client
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.latrobe.edu.au/", name = "subtract")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.latrobe.edu.au/", name = "DivideByZeroException")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.latrobe.edu.au/", name = "addResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.latrobe.edu.au/", name = "multiplyResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.latrobe.edu.au/", name = "divide")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.latrobe.edu.au/", name = "multiply")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.latrobe.edu.au/", name = "add")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.latrobe.edu.au/", name = "divideResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.latrobe.edu.au/", name = "subtractResponse")
