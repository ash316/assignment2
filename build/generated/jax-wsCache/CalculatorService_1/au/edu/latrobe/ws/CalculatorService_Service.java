 ...
 * 
 */
@WebServiceClient(name = "CalculatorService", targetNamespace = "http://ws.latrobe.edu.au/", wsdlLocation = "http://localhost:8080/Assignment2/CalculatorService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CALCULATORSERVICE_QNAME = new QName("http://ws.latrobe.edu.au/", "CalculatorService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/Assignment2/CalculatorService?wsdl");
    ...
    public CalculatorService getCalculatorServicePort() {
        return super.getPort(new QName("http://ws.latrobe.edu.au/", "CalculatorServicePort"), CalculatorService.class);
    }
    ...
    public CalculatorService getCalculatorServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws.latrobe.edu.au/", "CalculatorServicePort"), CalculatorService.class, features);
    }
